...
public class BkTreeNode {
     ...
     * children.
     *
     * @param item The sequence item of this node
     */
     ...
     *
     * @param newSequenceString The string sequence to be added
     */
     ...
     * @param limit         The limit of distance
     * @param results       The query results of nodes within distance limit from query
     *                      term
     */
