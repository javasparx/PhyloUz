...
public class BkTreeEditDist {
    ...
    public BkTreeEditDist(String querySeqFile, String dataSeqFile) {
        ...
        FastaReader reader = new FastaReader(FastaFileContent.DNA_SEQUENCE, querySeqFile);
        reader.processFile();
     ...
     * @param dataSeq  The list of all sequences in the BK-Tree
     * @param bkTree   The BK-Tree containing all sequences
     ...
     *
     * @param urlPath  The url path to download
     * @param filePath The path to file to save to
     * @throws java.net.MalformedURLException Thrown if urlPath is malformed
     * @throws java.io.IOException            Thrown if any problem writing to filePath
     */
     ...
     *
     * @param aluNucleotideSeq The list of ALU element sequences
     ...
     *
     * @param querySeq        The query sequence
     * @param bkTree          The BK-Tree containing both query sequence as root, and other
     *                        ALU elements
     * @param maxEditDistance Used as the number of iterations of queries, from
     *                        0..maxEditDistance
     ...
     * @param results       The array containing query results
