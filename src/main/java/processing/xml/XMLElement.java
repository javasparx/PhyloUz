...
public class XMLElement {
     ...
     *
     * @author processing.org
     * @see XMLElement#getDoubleAttribute() but added to
     ...
     * @throws processing.xml.XMLParseException If an error occured while parsing the read data.
     */
     ...
     *               parsed from the reader
     *               </ul></dd></dl><dl>
     * @throws processing.xml.XMLParseException If an error occured while parsing the string.
     */
