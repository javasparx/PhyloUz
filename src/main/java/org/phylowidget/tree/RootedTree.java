...
public class RootedTree<V extends DefaultVertex, E extends DefaultWeightedEdge> extends
     ...
     *
     * @param enforceUniqueLabels If true, then this RootedTree will ensure that node labels are
     *                            unique.
     */
     ...
     *
     * @param a        the parent node (edge source)
     * @param b        the child node (edge target)
     * @param insertMe
     */
     ...
     *
     * @param parent the vertex whose direct children to flip.
     */
