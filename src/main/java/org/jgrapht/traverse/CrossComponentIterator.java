 ...
 * (http://sourceforge.net/users/barak_naveh) (C) Copyright 2003-2007, by Barak
 * Naveh and Contributors. This library is free software; you can redistribute
 ...
 * --------------------------- (C) Copyright 2003-2007, by Barak Naveh and
 * Contributors. Original Author: Barak Naveh Contributor(s): John V. Sichi
 * Christian Hammer $Id: CrossComponentIterator.java 568 2007-09-30 00:12:18Z
 * perfecthash $ Changes ------- 31-Jul-2003 : Initial revision (BN);
 * 11-Aug-2003 : Adaptation to new event model (BN); 31-Jan-2004 : Extracted
 * cross-component traversal functionality (BN); 04-May-2004 : Made generic (CH)
