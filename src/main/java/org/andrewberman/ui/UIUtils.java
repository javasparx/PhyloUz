...
public final class UIUtils {
     ...
     *
     * @param tr  the source <code>AffineTransformation</code>
     * @param mat the destination <code>PMatrix3D</code>
     */
     ...
     *
     * @param g the current <code>PGraphics</code>
     * @param c the <code>Color</code> object to convert
     ...
     *
     * @param pg   a <code>PGraphicsJava2D</code> instance
     ...
     * PGraphics context.
     *
     * @param g              a PGraphics object
     * @param font           a <code>PFont</code> object
     * @param size           the font size
     * @param useNativeFonts true if the caller wishes to use Java's built-in font
     *                       functionality
     ...
     *
     * @param p the current <code>PApplet</code>
     ...
     *
     * @param canvas the <code>PGraphics</code> object to test
     ...
     * place.
     *
     * @param pt The point to transform in place. Should currently contain
     *           model coordinates.
     */
     ...
     *
     * @param o The object that is requesting this cursor release.
     * @param p The current PApplet
     */
     ...
     * place.
     *
     * @param pt The point to transform in place. Should currently contain the
     *           mouse coordinates.
     */
     ...
     *
     * @param rect the <code>Redtangle2D</code> to convert (in place) from screen
     ...
     *
     * @param o      The object which is requesting the cursor change.
     * @param p      The current PApplet
     * @param cursor the cursor to change to (i.e. Cursor.HAND_CURSOR).
     */
     ...
     * associated methods.
     *
     * @param p the PApplet from which to glean the matrix information.
     * @see UIUtils.screenToModel
     */
     ...
     *
     * @param mat the transformation <code>PMatrix3D</code>
     * @param pt  the <code>Point</code> to be transformed in place
     */
