 ...
 * @see java.awt.Color
 */
public final class ColorStringParser {

    private static final ColorStringParser INSTANCE = new ColorStringParser();

    /**
     * Returns a {@link org.andrewberman.ui.unsorted.ColorStringParser}.
     * <p/>
     * <p>Convenient access to the only instance returned by
     * this method is available through
     * {@link org.coffeeshop.arguments.Arguments#COLOR_PARSER}.
     *
     * @return a {@link org.andrewberman.ui.unsorted.ColorStringParser}.
     */
    ...
    /**
     * Simple utility for creating Exceptions, as there are so many
     * opportunities to throw them.
     *
     * @param s the Exception's message.
     * @return a new Exception with the specified message.
     */
     ...
     * @throws Exception if the specified String cannot be interpreted as
     *                   a Color.
     */
     ...
     * @throws Exception if the specified String is not a valid color name.
     */
     ...
     * @throws Exception if the specified String contains fewer than 3 or
     ...
     * @throws Exception if arg cannot be interpreted as a Color as
     *                   described above.
     */
    public Object parse(String arg) throws Exception {
        ...
        if (arg.charAt(0) == '#') {
            ...
            result = parseHexColor("#" + arg); // HACK gj 2008-08-05. Parse a 6-length string without a "#" as a hex value.
        } else {
